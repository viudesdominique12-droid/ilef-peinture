...
export default function Contact() {
  ...
  const inputClass = "w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-md text-sm text-gray-800 focus:outline-none focus:border-rose transition-colors placeholder:text-gray-400"
      ...
      <section className="pt-28 pb-10 md:pt-36 md:pb-14 section-padding">
        <div className="max-w-3xl">
          ...
          <h1 className="hero-animate hero-animate-2 heading-xl mb-3">
            Nous <span className="italic text-rose">contacter</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-5 gap-10 lg:gap-16">
            ...
            <AnimatedSection>
              <div className="space-y-5">
                <a href="tel:0659797855" className="flex items-center gap-3 group">
                  ...
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-gray-600">Téléphone</p>
                    <p className="text-rose font-serif text-lg group-hover:text-rose-light transition-colors">06 59 79 78 55</p>
                  </div>
                </a>
                <a href="mailto:walidbenzina80@gmail.com" className="flex items-center gap-3 group">
                  ...
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-gray-600">Email</p>
                    <p className="text-sm text-gray-800 group-hover:text-rose transition-colors">walidbenzina80@gmail.com</p>
                  </div>
                </a>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-rose/10 flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-rose" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>
                  </div>
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-gray-600">Adresse</p>
                    <p className="text-sm text-gray-400">7 Allée des mécaniciens, 49800 Trélazé</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-rose/10 flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-rose" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  </div>
                  <div>
                    <p className="text-[10px] tracking-[0.2em] uppercase text-gray-600">Zone</p>
          ...
          <div className="lg:col-span-3">
            <AnimatedSection variant="fadeRight" delay={0.1}>
              <div className="bg-light border border-gray-200 p-6 md:p-8 rounded-lg">
                {submitted ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-600">Nous revenons vers vous sous 48h.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[10px] tracking-[0.2em] uppercase text-gray-600 mb-1.5">Nom *</label>
                        <input type="text" name="nom" required value={formData.nom} onChange={handleChange} className={inputClass} placeholder="Jean Dupont" />
                      </div>
                      <div>
                        <label className="block text-[10px] tracking-[0.2em] uppercase text-gray-600 mb-1.5">Téléphone *</label>
                    ...
                    <div>
                      <label className="block text-[10px] tracking-[0.2em] uppercase text-gray-600 mb-1.5">Type de travaux</label>
                    ...
                    <div>
                      <label className="block text-[10px] tracking-[0.2em] uppercase text-gray-600 mb-1.5">Message *</label>
